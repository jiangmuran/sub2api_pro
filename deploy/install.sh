...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/jiangmuran/sub2api_pro/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="jiangmuran/sub2api_pro"
...
download_and_extract() {
	...
	local archive_name="sub2api_pro_${version_num}_${OS}_${ARCH}.tar.gz"
...
Documentation=https://github.com/jiangmuran/sub2api_pro
