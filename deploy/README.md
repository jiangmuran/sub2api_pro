...
curl -sSL https://raw.githubusercontent.com/jiangmuran/sub2api_pro/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/jiangmuran/sub2api_pro/releases)
