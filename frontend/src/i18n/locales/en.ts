export default {
  ...
  common: {
    ...
    contactSupport: 'Join Group Chat',
    add: 'Add',
  ...
  voiceChat: {
    ...
    checks: {
      ...
      serverHint: 'Checks whether the selected key is allowed to use voice.',
    ...
    log: {
      ...
      preflightSuccess: 'Server capability and browser checks completed successfully.',
  ...
  redeem: {
    ...
    codeRule3: 'Join the group chat if you have issues redeeming a code',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportTitle: 'Import Accounts / Compatible APIs',
      dataImportHint:
        'Upload a JSON file to import accounts in bulk. Both sub2api export files and OpenAI Compatible import files are supported.',
      dataImportSupportedFormats:
        'Supported formats: 1) sub2api export JSON; 2) compatible API JSON with `type: "openai-compatible-import"`. Compatible imports are normalized into OpenAI API Key accounts with safer passthrough defaults.',
      dataImportWarning:
        'Import creates new accounts. Actual compatibility still depends on upstream behavior; groups must be bound manually, so make sure the incoming data does not conflict with existing accounts.',
      ...
      batchTest: {
        ...
        delay: 'Request Delay',
        delayHint: 'Delay between requests to avoid rate limiting',
        concurrency: 'Concurrency',
        concurrencyHint: 'Number of accounts to test simultaneously',
        timeout: 'Timeout',
        start: 'Start Test',
        stop: 'Stop Test',
        testing: 'Testing...',
        ...
        confirmStop: 'Are you sure you want to stop the test?',
        cancelled: 'Test cancelled',
        completeMessage: 'Batch test completed, tested {count} account(s)',
      ...
      openai: {
        ...
        compatCheckFailedToast: 'Compatibility check failed',
        compatOverallStatus: 'Overall status',
        compatRecommendedMode: 'Recommended mode',
        ...
        compatCheckUnsupported: 'Unsupported',
        compatCheckFailed: 'Fail',
        compatNoDetail: 'No extra detail',
        compatAppliedHint:
          'The recommended configuration has been applied: {mode}. You can still fine-tune passthrough and model mapping manually.',
        compatBaseUrlRequired: 'Please enter a Base URL first',
        compatApiKeyRequired: 'Please enter an API Key first',
        workbenchTitle: 'Test Models',
        workbenchDesc: 'Inspect live compatible models, preview pricing, and run multi-turn chats in one place.',
        refreshWorkbench: 'Fetch Online',
        workbenchEmpty: 'Fill in Base URL and API Key first, then load the live model list here.',
        workbenchModels: 'Models',
        workbenchPricing: 'Pricing',
        workbenchChat: 'Chat',
        previewApiKeyTitle: 'Preview API Key',
        previewApiKeyPlaceholder: 'Enter the upstream API key used for the live chat preview',
        previewApiKeyHint: 'This key is used directly for the current upstream preview. You can quickly refill it from the account key.',
        useAccountKey: 'Use Account Key',
        accountKeyApplied: 'Applied the account API key',
        userTestApiKeyTitle: 'User Test API Key',
        userTestApiKeyPlaceholder: 'Paste an existing user key, or generate a fresh test key in one click',
        generateUserTestApiKey: 'Generate',
        userTestApiKeyHint: 'The generated key is copied automatically and is useful for gateway-side testing after the account is saved.',
        userTestApiKeyGenerated: 'Generated and copied a user test API key',
        userTestApiKeyGenerateFailed: 'Failed to generate a user test API key',
        userTestApiKeyCopied: 'Copied the user test API key',
        onlineModelsTitle: 'Live Model List',
        onlineModelsDesc: 'Reads the provider model list directly, which is useful for flaky compatible APIs.',
        applyOnlineModels: 'Apply Online Models',
        noOnlineModels: 'No models loaded yet',
        onlineModelsApplied: 'Applied the live model list',
        ...
        chatPlaceholder: 'Type your message here. Conversation context is preserved.',
        chatHint: 'This preview currently prefers the provider chat/completions capability.',
        chatSending: 'Sending...',
        sendChat: 'Send Message',
        chatFailed: 'Chat preview failed',
        emptyReply: 'The upstream returned an empty reply',
        workbenchLoadFailed: 'Failed to load live models',
    ...
    redeem: {
      ...
      invitationStatsHint:
        'Invitation codes are used for registration; the stats below help you understand how many have been used.',
      invitationTotal: 'Total invitation codes',
      invitationUsed: 'Used invitation codes',
      invitationUnused: 'Unused invitation codes',
      viewInvitationImpact: 'View impact',
      invitationImpactTitle: 'Invitation impact analytics',
      invitationCodeLabel: 'Invitation code',
      invitationImpactEmpty: 'No impact data available for this invitation code yet.',
      registeredUser: 'Registered user',
      subscriptionRedeemsTotal: 'Subscription redeems from this user',
      invitationCategory: 'Invitation category',
      byRedeemCategory: 'By redeem category',
      bySubscriptionGroup: 'By subscription group',
      redeemCount: 'Redeem count',
      noSubscriptionRedeems: 'No subscription-type redeem codes used yet',
    ...
    distributor: {
      ...
      validityDays: 'Validity (days)',
      cost: 'Cost',
      selectAllOffers: 'Select All',
      bulkUpdate: 'Batch Update',
      bulkValidityPlaceholder: 'Batch validity days (optional)',
      bulkCostPlaceholder: 'Batch cost CNY (optional)',
      bulkSelectionRequired: 'Please select offers to batch update',
      bulkFieldsRequired: 'Please provide batch validity days or cost',
      bulkUpdated: 'Updated {count} offer(s)',
      searchOrders: 'Search orders...',
      revoke: 'Revoke',
      code: 'Redeem Code',
      status: 'Status',
    ...
    promo: {
      ...
      userPrefix: 'User #{id}',
      copied: 'Copied!',
      usageStatsFor: 'Usage stats for "{code}"',
      totalUses: 'Total uses',
      uniqueUsers: 'Unique users',
      totalBonus: 'Total bonus',
      usesToday: 'Uses today',
      uses7d: 'Uses in last 7 days',
      uses30d: 'Uses in last 30 days',
      // Messages
    ...
    ops: {
      ...
      tooltips: {
        ...
        disk: 'Disk usage, including used and total available disk space.',
    ...
    settings: {
      ...
      site: {
        ...
        contactInfo: 'Community Group URL',
        contactInfoPlaceholder: 'https://t.me/example',
        contactInfoHint: 'Configure a group invite link. It will be shown on redeem, profile, and user menu pages and opened in a new tab.',
