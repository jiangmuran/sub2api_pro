export default {
  ...
  admin: {
    ...
    redeem: {
      ...
      subscription: '订阅',
      invitation: '邀请码',
      invitationHint: '邀请码用于限制用户注册，使用后会自动标记为已使用。',
      unused: '未使用',
      used: '已使用',
      ungrouped: '未分组',
      columns: {
      ...
      categoryStats: '分类统计',
      noCategoryStats: '暂无分类统计数据',
      userPrefix: '用户 #{id}',
      exportCsv: '导出 CSV',
      deleteAllUnused: '删除所有未使用卡密',
      deleteCode: '删除兑换码',
      deleteCodeConfirm: '确定要删除该兑换码吗？此操作无法撤销。',
      deleteAllUnusedConfirm: '确定要删除所有未使用（激活中）的兑换码吗？此操作无法撤销。',
      deleteAll: '全部删除',
      generateCodesTitle: '生成兑换码',
      generatedSuccessfully: '生成成功',
      codesCreated: '已生成 {count} 个兑换码',
      codeType: '兑换码类型',
      category: '分类',
      notes: '备注',
      amount: '金额 ($)',
      ...
      codesExported: '兑换码导出成功',
      codeDeleted: '兑换码删除成功',
      codesDeleted: '已成功删除 {count} 个未使用兑换码',
      noUnusedCodes: '没有可删除的未使用兑换码',
      failedToLoad: '加载兑换码失败',
      failedToGenerate: '生成兑换码失败',
      failedToExport: '导出兑换码失败',
      failedToDelete: '删除兑换码失败',
      failedToDeleteUnused: '删除未使用兑换码失败',
      failedToCopy: '复制兑换码失败',
      types: {
        balance: '余额',
        concurrency: '并发',
        subscription: '订阅',
        invitation: '邀请码',
        admin_balance: '余额（管理员）',
        admin_concurrency: '并发（管理员）'
      },
      selectGroup: '选择订阅分组',
      selectGroupPlaceholder: '请选择订阅分组',
      validityDays: '有效天数',
