...
const (
	...
	PlatformNanoBanana  = domain.PlatformNanoBanana
)
...
const (
	...
	SettingKeySMTPProxyURL = "smtp_proxy_url" // SMTP 代理 URL（仅支持 socks5/socks5h）
	...
	SettingKeyContactInfo                 = "contact_info"                  // 交流群链接（历史字段名保留）
