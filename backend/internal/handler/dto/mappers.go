...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		OAuthStatus:             a.OpenAIOAuthStatus(),
		OAuthRefreshAttempts:    a.OAuthRefreshAttempts,
		OAuthNextRefreshAt:      a.OAuthNextRefreshAt,
		OAuthLastRefreshAt:      a.OAuthLastRefreshAt,
