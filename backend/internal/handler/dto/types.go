...
type User struct {
	...
	RegistrationSourceCode string    `json:"registration_source_code,omitempty"`
...
type Account struct {
	...
	OAuthRefreshAttempts int            `json:"oauth_refresh_attempts"`
	OAuthNextRefreshAt   *time.Time     `json:"oauth_next_refresh_at"`
	OAuthLastRefreshAt   *time.Time     `json:"oauth_last_refresh_at"`
