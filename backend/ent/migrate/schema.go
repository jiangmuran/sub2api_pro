...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "oauth_status", Type: field.TypeString, Size: 30, Default: "active"},
		{Name: "oauth_refresh_attempts", Type: field.TypeInt, Default: 0},
		{Name: "oauth_next_refresh_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "oauth_last_refresh_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "oauth_last_error", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "account_oauth_status",
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[14]},
			},
			{
				Name:    "account_oauth_next_refresh_at",
				Unique:  false,
