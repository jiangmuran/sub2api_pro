...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	securityChatAIService := service.NewSecurityChatAIService(settingService, apiKeyService, userService, openAIGatewayService)
	securityHandler := admin.NewSecurityHandler(securityChatService, securityChatAIService)
